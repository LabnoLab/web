  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <h2>Próximo curso: sep 2025</h2>
        <h2>En clave de inteligencia artificial</h2>
        <h2>
          Por aquí somos fans de la pregunta, así que déjanos hacerte alguna: ¿Sientes que hay un enorme potencial en la IA, pero no sabes cómo aprovecharlo manteniendo tu identidad y propósito? ¿Te interesa no solo obtener respuestas, sino aprender a formular mejores preguntas? ¿Buscas diferenciarte en un mercado saturado donde todos usan la misma tecnología de la misma manera?<br /><br />
          En clave de IA es el mega curso de LabnoLab que hará que <strong>pienses, interactúes, investigues, innoves, comuniques y analices</strong> en clave de Inteligencia Creativa, no solo de Inteligencia Artificial. <br /><br />
          Si quieres saber más, descarga el dosier o escríbenos por Whatsapp y te contamos.
        </h2>
        <a href="https://wa.me/34615877069" target="_blank">
          {/* SVG 3 */}
        ...
        <h2><i>¿qué hacemos?&nbsp;&nbsp;&nbsp;¿qué hacemos?&nbsp;&nbsp;&nbsp;</i></h2>
        <a href="https://labnolab.com/wp-content/uploads/2025/02/2-1.png" data-elementor-open-lightbox="yes" data-elementor-lightbox-title="2" data-e-action-hash="#elementor-action%3Aaction%3Dlightbox%26settings%3DeyJpZCI6MjExNCwidXJsIjoiaHR0cHM6XC9cL2xhYm5vbGFiLmNvbVwvd3AtY29udGVudFwvdXBsb2Fkc1wvMjAyNVwvMDJcLzItMS5wbmcifQ%3D%3D">
          <img width="1024" height="724" src="https://labnolab.com/wp-content/uploads/2025/02/2-1.png" alt="" />
        </a>
        <h2>Formación</h2>
        <h2>Cursos completos para trabajar las 6 fases de la Metodología LabnoLab: <strong>pensar, interactuar, investigar, innovar, comunicar y analizar en clave de IA</strong>; orientados y adaptados a diferentes perfiles profesionales: perfil emprendedor, docente, directivo, creativo…</h2>
        <a href="#">
          {/* SVG 4 */}
        ...
        <a href="https://labnolab.com/wp-content/uploads/2025/02/Diseno-sin-titulo-3-1.png" data-elementor-open-lightbox="yes" data-elementor-lightbox-title="Diseño sin título (3)" data-e-action-hash="#elementor-action%3Aaction%3Dlightbox%26settings%3DeyJpZCI6MjExNiwidXJsIjoiaHR0cHM6XC9cL2xhYm5vbGFiLmNvbVwvd3AtY29udGVudFwvdXBsb2Fkc1wvMjAyNVwvMDJcL0Rpc2Vuby1zaW4tdGl0dWxvLTMtMS5wbmcifQ%3D%3D">
          <img width="1024" height="724" src="https://labnolab.com/wp-content/uploads/2025/02/Diseno-sin-titulo-3-1.png" alt="" />
        </a>
        <h2>Workshops</h2>
        <h2>Sesiones inmersivas de 2-4 horas donde <strong>desbloqueamos el pensamiento en clave de IA</strong>, colaborando con ella en ejemplos concretos de un proyecto o reto</h2>
        <a href="#">
          {/* SVG 5 */}
          <svg aria-hidden="true" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M313.941 216H12c-6.627 0-12 5.373-12 12v56c0 6.627 5.373 12 12 12h301.941v46.059c0 21.382 25.851 32.09 40.971 16.971l86.059-86.059c9.373-9.373 9.373-24.569 0-33.941l-86.059-86.059c-15.119-15.119-40.971-4.411-40.971 16.971V216z"></path></svg>
          Más Info
        </a>
        <a href="https://labnolab.com/wp-content/uploads/2025/02/5-1.png" data-elementor-open-lightbox="yes" data-elementor-lightbox-title="5" data-e-action-hash="#elementor-action%3Aaction%3Dlightbox%26settings%3DeyJpZCI6MjExMywidXJsIjoiaHR0cHM6XC9cL2xhYm5vbGFiLmNvbVwvd3AtY29udGVudFwvdXBsb2Fkc1wvMjAyNVwvMDJcLzUtMS5wbmcifQ%3D%3D">
          <img width="1024" height="724" src="https://labnolab.com/wp-content/uploads/2025/02/5-1.png" alt="" />
        </a>
        <h2>Capacitación</h2>
        <h2>Adaptamos nuestra metodología para crear <strong>programas formativos a medida</strong> para equipos con necesidades específicas, integrando la IA en sus flujos de trabajo sin que pierdan su identidad.</h2>
        <a href="#">
          {/* SVG 6 */}
          <svg aria-hidden="true" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M313.941 216H12c-6.627 0-12 5.373-12 12v56c0 6.627 5.373 12 12 12h301.941v46.059c0 21.382 25.851 32.09 40.971 16.971l86.059-86.059c9.373-9.373 9.373-24.569 0-33.941l-86.059-86.059c-15.119-15.119-40.971-4.411-40.971 16.971V216z"></path></svg>
          Más Info
        </a>
        <a href="https://labnolab.com/wp-content/uploads/2025/04/Mentorias.png" data-elementor-open-lightbox="yes" data-elementor-lightbox-title="Mentorías" data-e-action-hash="#elementor-action%3Aaction%3Dlightbox%26settings%3DeyJpZCI6MjQyMSwidXJsIjoiaHR0cHM6XC9cL2xhYm5vbGFiLmNvbVwvd3AtY29udGVudFwvdXBsb2Fkc1wvMjAyNVwvMDRcL01lbnRvcmlhcy5wbmcifQ%3D%3D">
          <img width="600" height="600" src="https://labnolab.com/wp-content/uploads/2025/04/Mentorias.png" alt="" />
        </a>
        <h2>Mentorías </h2>
        <h2>Acompañamiento one-to-one para <strong>emprendedoras/es que buscan potenciar su proyecto</strong> colaborando con la Inteligencia Artificial.</h2>
        <a href="#">
          {/* SVG 7 */}
          <svg aria-hidden="true" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M313.941 216H12c-6.627 0-12 5.373-12 12v56c0 6.627 5.373 12 12 12h301.941v46.059c0 21.382 25.851 32.09 40.971 16.971l86.059-86.059c9.373-9.373 9.373-24.569 0-33.941l-86.059-86.059c-15.119-15.119-40.971-4.411-40.971 16.971V216z"></path></svg>
          Más Info
        </a>
        <a href="https://labnolab.com/wp-content/uploads/2025/04/Captura-de-pantalla-2025-04-12-174424.png" data-elementor-open-lightbox="yes" data-elementor-lightbox-title="Captura de pantalla 2025-04-12 174424" data-e-action-hash="#elementor-action%3Aaction%3Dlightbox%26settings%3DeyJpZCI6MjU0MiwidXJsIjoiaHR0cHM6XC9cL2xhYm5vbGFiLmNvbVwvd3AtY29udGVudFwvdXBsb2Fkc1wvMjAyNVwvMDRcL0NhcHR1cmEtZGUtcGFudGFsbGEtMjAyNS0wNC0xMi0xNzQ0MjQucG5nIn0%3D">
          <img width="1069" height="708" src="https://labnolab.com/wp-content/uploads/2025/04/Captura-de-pantalla-2025-04-12-174424.png" alt="" />
        </a>
        <h2>Consultoría</h2>
        <h2>Transformación integral de procesos y <strong>creación de soluciones de IA on-demand</strong>, automatizaciones y mejora de la productividad que amplifican el potencial humano sin reemplazarlo.</h2>
        <a href="#">
          {/* SVG 8 */}
          <svg aria-hidden="true" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M313.941 216H12c-6.627 0-12 5.373-12 12v56c0 6.627 5.373 12 12 12h301.941v46.059c0 21.382 25.851 32.09 40.971 16.971l86.059-86.059c9.373-9.373 9.373-24.569 0-33.941l-86.059-86.059c-15.119-15.119-40.971-4.411-40.971 16.971V216z"></path></svg>
          Más Info
        </a>
        <a href="https://labnolab.com/wp-content/uploads/2025/02/1-1.png" data-elementor-open-lightbox="yes" data-elementor-lightbox-title="1" data-e-action-hash="#elementor-action%3Aaction%3Dlightbox%26settings%3DeyJpZCI6MjExMSwidXJsIjoiaHR0cHM6XC9cL2xhYm5vbGFiLmNvbVwvd3AtY29udGVudFwvdXBsb2Fkc1wvMjAyNVwvMDJcLzEtMS5wbmcifQ%3D%3D">
          <img width="1024" height="724" src="https://labnolab.com/wp-content/uploads/2025/02/1-1.png" alt="" />
        </a>
        <h2>Hackathons</h2>
        <h2>Jornadas creativas de co-creación donde colaboramos con la IA para resolver desafíos complejos y generar <strong>innovación disruptiva sobre retos concretos</strong> de equipos u organizaciones.</h2>
        <a href="#">
          {/* SVG 9 */}
          <svg aria-hidden="true" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M313.941 216H12c-6.627 0-12 5.373-12 12v56c0 6.627 5.373 12 12 12h301.941v46.059c0 21.382 25.851 32.09 40.971 16.971l86.059-86.059c9.373-9.373 9.373-24.569 0-33.941l-86.059-86.059c-15.119-15.119-40.971-4.411-40.971 16.971V216z"></path></svg>
          Más Info
        </a>
        <h2>Próxima formación en</h2>
        <ul id="wpkoi-elements-countdown-35a39ff9" data-date="May 13 2025 0:00:00">
          <li>00Days</li>
          <li>00Hours</li>
          <li>00Minutes</li>
          <li>00Seconds</li>
        </ul>
        <h2><i>Pronto más novedades</i></h2>
        <h2><i>¿Quieres preguntarnos algo?&nbsp;&nbsp;&nbsp;¿Quieres preguntarnos algo?&nbsp;&nbsp;&nbsp;</i></h2>
        <div className="shortcode">[contact-form-7 id="8bf8d90" title="Formulario web - Asunto cool"]</div>
        <iframe
          loading="lazy"
        ...
        <h2><a href="https://wa.me/34615877069" target="_blank">+34615877069</a></h2>
        <svg aria-hidden="true" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M464 64H48C21.49 64 0 85.49 0 112v288c0 26.51 21.49 48 48 48h416c26.51 0 48-21.49 48-48V112c0-26.51-21.49-48-48-48zm0 48v40.805c-22.422 18.259-58.168 46.651-134.587 106.49-16.841 13.247-50.201 45.072-73.413 44.701-23.208.375-56.579-31.459-73.413-44.701C106.18 199.465 70.425 171.067 48 152.805V112h416zM48 400V214.398c22.914 18.251 55.409 43.862 104.938 82.646 21.857 17.205 60.134 55.186 103.062 54.955 42.717.231 80.509-37.199 103.053-54.947 49.528-38.783 82.032-64.401 104.947-82.653V400H48z"></path></svg>
        <h2>hola.labnolab@gmail.com</h2>
        ...
        <a href="https://www.linkedin.com/company/labnolab/" target="_blank">
          <svg aria-hidden="true" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg"><path d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448z"></path></svg>
        </a>
        <h2><a href="https://www.linkedin.com/company/labnolab/" target="_blank">LabnoLab Page</a></h2>
      </div>
    </>
  );
} 